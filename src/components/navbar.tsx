    ...
    return (
        <header>
            <a href="/" style={{ textDecoration: 'none', color: 'inherit' }}>
                <div className="brand">
                    <span className="foss-text">foss</span><span className="radar-text">radar</span>
                </div>
            </a>
            ...
            <div className="nav-actions">
                ...
                <button className="theme-toggle" onClick={toggleTheme} aria-label="Toggle Theme" style={{ background: 'none', border: 'none', cursor: 'pointer' }}>
                    {theme === 'dark' ? (
